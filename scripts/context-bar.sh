...
five_hr_reset_str=$(format_reset "$five_hr_resets")
seven_day_reset_str=$(format_reset "$seven_day_resets")
five_hr_bar=$(make_bar "$five_hr_pct")
seven_day_bar=$(make_bar "$seven_day_pct")
